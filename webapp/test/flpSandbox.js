		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bereitschaftseinsatz",
									"targetURL": "#zbereitschaftseinsatz-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbereitschaftseinsatz-display": {
								"semanticObject": "zbereitschaftseinsatz",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbereitschaftseinsatz",
									"url": sap.ui.require.toUrl("zbereitschaftseinsatz")
								}
							}
						}
					}
